...
function Bag() {
  ...
  return (
    <div className="w-full h-full">
      <ul className="w-full h-[85%] flex pt-[60px] relative gap-2">
      ...
      <div className="w-full flex flex-col justify-center items-center">
        ...
        <button className="w-[95%] text-sm py-[6px] font-bold font-Slab justify-center items-center flex bg-gradient-to-r from-slate-500 via-slate-800 to-slate-900 rounded-md mt-2 text-white relative before:absolute before:top-0 before:right-full before:left-0 before:bottom-0 hover:before:right-0 before:transition-all before:ease-in-out overflow-hidden hover:text-white before:z-[5] before:bg-zinc-600">
