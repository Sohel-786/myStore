      ...
      <div className="bg-white w-full">
        <div className="w-[70%] py-4 mx-auto relative -top-10 bg-white rounded-t-3xl">
          <ul className="flex justify-center items-center gap-8 font-Roboto font-semibold tracking-wide">
            <li className="relative font-bold pb-1 cursor-pointer before:absolute before:h-1 before:bottom-0 before:bg-black before:w-full focus:before:w-full hover:before:duration-200 before:ease-in before:duration-300 scale-110 transition-all duration-200">
              Home
            </li>
